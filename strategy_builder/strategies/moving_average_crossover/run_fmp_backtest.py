...
if __name__ == "__main__":
    ...
    if not api_key:
        ...
        print("Example:")
        print("  python -m strategy_builder.strategies.moving_average_crossover.run_fmp_backtest --api-key YOUR_API_KEY")
        print("  # OR")
        print("  Add FMP_API_KEY=your-api-key to your .env file")
        print("  # OR")
        print("  export FMP_API_KEY='your-api-key'")
        print("  python -m strategy_builder.strategies.moving_average_crossover.run_fmp_backtest")
        sys.exit(1)
